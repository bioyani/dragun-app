    ...
    <main className="relative isolate min-h-screen bg-[#0b1b2b] text-white overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-32 pb-36 space-y-12 relative z-10">
        <div className="text-center space-y-4">
          ...
          <p className="text-base md:text-lg text-white/60 leading-relaxed max-w-3xl mx-auto font-medium tracking-tight">
            {t('paragraph')}
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-8 pt-12">
          <div className="rounded-[2.5rem] border border-white/10 bg-white/[0.03] p-8 space-y-4 shadow-xl">
            <h3 className="text-lg font-black text-white uppercase tracking-widest">{t('speedTitle')}</h3>
            <p className="text-white/60 text-sm leading-relaxed font-medium">{t('speedDesc')}</p>
          </div>
          <div className="rounded-[2.5rem] border border-white/10 bg-white/[0.03] p-8 space-y-4 shadow-xl">
            <h3 className="text-lg font-black text-white uppercase tracking-widest">{t('foundedTitle')}</h3>
            <p className="text-white/60 text-sm leading-relaxed font-medium">{t('foundedDesc')}</p>
          </div>
        </div>
      </div>
    </main>
